...
public class FirstAKWUnfall extends OverlayGame {
	
	public FirstAKWUnfall(Game g) {
		super(g);
	}
	...
	public void init(){
		...
		buttons[0] = new ButtonCenteredText(this, "Lauft um euer Leben!", c_rclick_caption, c_rclick_button_highlight, left+width/2, top+height-35, f_rclick_button, r);
	}
	...
	public void draw() {
		...
		g.drawString("Hast du das gehört? Das war der Katastrophenalarm!", left+15, top+15+caption_height+20);
		g.drawString("Das heißt eines deiner Atomkraftwerke hat einen Unfall.", left+15, top+15+caption_height+35);
